...
<div class="hero-slider-wrapper bg-dark">
    <div class="hero-slider owl-carousel dots-over" data-nav="true" data-dots="true" data-autoplay="true">
      <div class="owl-slide d-flex align-items-center bg-overlay bg-overlay-400 bg-image-7">
        <div class="container">
          <div class="row">
      ...
      <!--/.owl-slide -->
      <div class="owl-slide d-flex align-items-center bg-overlay bg-overlay-400 bg-image-8">
      ...
      <!--/.owl-slide -->
      <div class="owl-slide d-flex align-items-center bg-overlay bg-overlay-400 bg-image-9">
        <div class="container">
          <div class="row">
