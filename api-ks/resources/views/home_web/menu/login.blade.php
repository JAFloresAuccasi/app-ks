    ...
    <div class="container py-14 py-md-16">
      <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
        <div class="col-md-8 col-lg-6 offset-lg-0 col-xl-5 offset-xl-1 position-relative">
          <div class="shape bg-dot primary rellax w-17 h-21" data-rellax-speed="1" style="top: -2rem; left: -1.4rem; transform: translate3d(0px, -3px, 0px);"></div>
                ...
                <div class="col-lg-12">
                  <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    <div class="card-body text-center">
                      ...
                      <div class="form-check d-flex justify-content-start mb-4">
                        <a href="{{route('menu_sign_up')}}" class="form-check-label" style="color:red; text-decoration: underline;" for="form1Example3">Registrarse</a>
                      </div>
                      ...
                      <button class="btn btn-primary mb-2" style="background-color: #dd4b39; font-weight: 100 !important; border-color: none;"
                        type="submit"><i class="fab fa-google me-2"></i>Inicia sesión con Google</button>
                      <button class="btn btn-primary" style="background-color: #3b5998; font-weight: 100 !important; border-color: none;"
                        type="submit"><i class="fab fa-facebook-f me-2"></i>Inicia sesión con Facebook</button>
